# DisplayName: Jolla condor/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: condor
# DeviceVariant: condor
...
repo --name=adaptation-community-common-condor-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration condor
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/condor
